...
public class CaseSummaryResponseFactoryTests
{
	...
	private Decision BuildDecision()
		...
		Decision.CreateNew(
			...
			decisionTypes: new DecisionType[] { new (Data.Enums.Concerns.DecisionType.NoticeToImprove, Data.Enums.Concerns.DecisionDrawdownFacilityAgreed.No, Data.Enums.Concerns.DecisionFrameworkCategory.FacilitatingTransferFinanciallyTriggered) },
