    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NTIUnderConsiderationStatus>(entity =>
        {
            ...
            entity.HasData(
                ...
                {
                    new() { Id = 1, Name = "No further action being taken", CreatedAt = createdAt, UpdatedAt = createdAt },
        ...
        modelBuilder.Entity<NTIWarningLetterStatus>(entity =>
        {
            ...
            entity.HasData(
                ...
                {
                    new() { Id = 1, Name = "Preparing warning letter", CreatedAt = createdAt, UpdatedAt = createdAt, IsClosingState = false },
                    new() { Id = 2, Name = "Sent to trust", CreatedAt = createdAt, UpdatedAt = createdAt, IsClosingState = false },
