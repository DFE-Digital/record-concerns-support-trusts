...
public class CaseSummaryServiceTests
{
	...
	public async Task GetClosedCaseSummariesByTrust_WhenNoCases_ReturnsEmptyList()
	{
		...
		mockCaseSummaryService.Setup(s => s.GetClosedCaseSummariesByTrust(userName, 1)).ReturnsAsync(
			new ApiListWrapper<ClosedCaseSummaryDto>()
			{
				Data = new List<ClosedCaseSummaryDto>(),
				Paging = new Pagination()
			});
	...
	public async Task GetClosedCaseSummariesByTrust_WhenCases_ReturnsList()
	{
		...
		var data = BuildListClosedCaseSummaryDtos();
		mockCaseSummaryService.Setup(s => s.GetClosedCaseSummariesByTrust(userName, 1)).ReturnsAsync(new ApiListWrapper<ClosedCaseSummaryDto>()
		{
			Data = data,
			Paging = new Pagination()
			{
	...
	public async Task GetClosedCaseSummariesByTrust_WhenCasesWithMoreThan3DecisionsAndActions_ReturnsListWithIsMoreActionsAndDecisionsTrue()
	{
		...
		mockCaseSummaryService
			.Setup(s => s.GetClosedCaseSummariesByTrust(userName, 1))
			.ReturnsAsync(
			new ApiListWrapper<ClosedCaseSummaryDto>()
			{
				Data = new List<ClosedCaseSummaryDto>() { data },
	...
	public async Task GetActiveCaseSummariesByTrust_WhenNoCases_ReturnsEmptyList()
	{
		...
		mockCaseSummaryService.Setup(s => s.GetActiveCaseSummariesByTrust(userName, 1)).ReturnsAsync(
			new ApiListWrapper<ActiveCaseSummaryDto>()
			{
				Data = new List<ActiveCaseSummaryDto>(),
				Paging = new Pagination()
	...
	public async Task GetActiveCaseSummariesByTrust_WhenCasesWithMoreThan3DecisionsAndActions_ReturnsListWithIsMoreActionsAndDecisionsTrue()
	{
		...
		mockCaseSummaryService
			.Setup(s => s.GetActiveCaseSummariesByTrust(userName, 1))
			.ReturnsAsync(
			new ApiListWrapper<ActiveCaseSummaryDto>()
			{
				Data = new List<ActiveCaseSummaryDto>() { data },
