...
namespace ConcernsCaseWork.Data.Migrations
{
    ...
    [Migration("20260602141356_increase_riskToTrustRatingHistory_column_RationalCommentary_column_to_nvarchar_max")]
    partial class increase_riskToTrustRatingHistory_column_RationalCommentary_column_to_nvarchar_max
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConcernsCaseWork.Data.Models.ConcernsCase", b =>
                {
                    ...
                    b.Property<bool>("RatingRational")
                        .HasColumnType("bit");

                    b.Property<string>("RatingRationalCommentary")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ConcernsCaseWork.Data.Models.ConcernsCaseRiskToTrustRatingHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RationalCommentary")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.ToTable("ConcernsCaseRiskToTrustRatingHistory", "concerns", t =>
                        {
                            t.HasTrigger("ConcernsCaseRiskToTrustRatingHistory_Trigger");
                        });
            ...
            modelBuilder.Entity("ConcernsCaseWork.Data.Models.Decisions.DecisionDrawdownFacilityAgreed", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            Name = "ANewPackageWithDrawdown"
                        },
                        new
                        {
                            Id = 6,
                            Name = "ANewPackageWithImmediatePayment"
                        },
                        new
                        {
                            Id = 7,
                            Name = "ADrawdownFromAnExistingPackage"
                        });
                });
            ...
            modelBuilder.Entity("ConcernsCaseWork.Data.Models.Decisions.DecisionTypeId", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 12,
                            Name = "FinancialRecoveryOfFraudOrIrregularity"
                        });
                });
