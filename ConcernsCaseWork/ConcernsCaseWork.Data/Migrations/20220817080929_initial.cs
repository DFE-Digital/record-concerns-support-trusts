        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrmEnquiry = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TrustUkprn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReasonAtReview = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeEscalation = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Issue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CurrentStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CaseAim = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeEscalationPoint = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosedStatusId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ClosedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction); // TODO: Changed this from cascade
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, new DateTime(2021, 11, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "Force majeure", new DateTime(2021, 11, 17, 0, 0, 0, 0, DateTimeKind.Unspecified) },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "No further action being taken", new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) },
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CreatedAt", "Name", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cash flow problems", new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CreatedAt", "Description", "IsClosingState", "Name", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "", false, "Preparing warning letter", new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "", false, "Sent to trust", new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "The warning letter is no longer needed.", true, "Cancel warning letter", new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "You are satisfied that all the conditions have been, or will be, met as outlined in the letter", true, "Conditions met", new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Conditions have not been met. Close NTI: Warning letter and begin NTI on case page using \"Add to case\".", true, "Escalate to Notice To Improve", new DateTime(2022, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
