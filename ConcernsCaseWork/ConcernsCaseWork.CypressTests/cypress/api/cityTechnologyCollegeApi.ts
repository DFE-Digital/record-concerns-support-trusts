...
import {
    ResponseWrapper,
    CreateCityTechnologyCollegeRequest,
    CreateCityTechnologyCollegeResponse,
    GetCityTechnologyCollegeResponse,
} from './apiDomain';
...
class CityTechnologyCollegeApi extends ApiBase {
    public post(request: CreateCityTechnologyCollegeRequest): Cypress.Chainable<CreateCityTechnologyCollegeResponse> {
        return cy
            .request<CreateCityTechnologyCollegeResponse>({
                method: 'POST',
    ...
    public get(ukprn: string): Cypress.Chainable<GetCityTechnologyCollegeResponse> {
        return cy
            .request<GetCityTechnologyCollegeResponse>({
                method: 'GET',
