...
class CaseManagementPage {
    ...
    public withRationaleForClosure(reason: string): this {
        ...
        cy.getById("case-outcomes").clear();
        cy.getById("case-outcomes").type(reason);
    ...
    public withRationaleForClosureExceedingLimit(): this {
        ...
        cy.getById("case-outcomes").clear();
        cy.getById("case-outcomes").invoke("val", "x1".repeat(200));
    ...
    public hasConcerns(concern: string, ratingTags: Array<string>): this {
        ...
        cy.getByTestId("concerns_Field").contains(concern);
        cy.getByTestId("concerns_Field").parent()
            .find("td")
            .eq(1)
            .then((element) => {
