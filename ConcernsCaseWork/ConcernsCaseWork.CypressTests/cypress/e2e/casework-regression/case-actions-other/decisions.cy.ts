...
describe('User can add decisions to an existing case', () => {
    ...
    it('Creating, editing, validating then viewing a decision', function () {
        ...
        editDecisionPage
            ...
            .save()
            .hasValidationError(DateInvalidError.replace('{0}', 'Date SFSO received request'));
        ...
        editDecisionPage
            ...
            .save()
            .hasValidationError(DateIncompleteError.replace('{0}', 'Date SFSO received request'))
        ...
        Logger.log(
            'Ensure that selecting a sub question, selecting a value then deselecting disables and clears the field'
        );
        editDecisionPage
        ...
        actionSummaryTable.getOpenAction('Decision: Multiple Decision Types').then((row) => {
    ...
    it('Closing decision', function () {
        ...
        closeDecisionPage.withFinaliseSupportingNotes('This is a test for closed decision').closeDecision();
        ...
        actionSummaryTable.getClosedAction('Decision: Multiple Decision Types').then((row) => {
            row.hasName('Decision: Multiple Decision Types');
    ...
    it('When Decision is empty', function () {
        ...
        editDecisionPage.save().hasValidationError(NotesRequiredError);

        Logger.log('Creating Empty Decision with required notes');
        editDecisionPage.withSupportingNotes('decision notes').save();
        ...
        decisionOutcomePage.withDecisionOutcomeStatus('Withdrawn').saveDecisionOutcome();
    ...
    it('Create, edit and view a decision outcome, checking validation', () => {
        ...
        viewDecisionPage.hasNoDecisionOutcome().createDecisionOutcome();
