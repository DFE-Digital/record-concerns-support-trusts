...
describe('Testing the SRMA case action', () => {
    ...
    it('Should create an SRMA action', () => {
        ...
        editSrmaPage.withDayAccepted('22').withMonthAccepted('05').withYearAccepted('2020').save();
        ...
        editSrmaPage.withEndDayOfVisit('15').withEndMonthOfVisit('01').withEndYearOfVisit('2021').save();
        ...
        editSrmaPage.withEndDayOfVisit('15').withEndMonthOfVisit('08').withEndYearOfVisit('2021').save();
    ...
    it('Should edit an existing configured SRMA', () => {
        ...
        editSrmaPage.hasDayTrustContacted('22').hasMonthTrustContacted('10').hasYearTrustContacted('2022');

        editSrmaPage.clearDateTrustContacted().save().hasValidationError('Enter date trust was contacted');
        ...
        viewSrmaPage.addDateAccepted();
        editSrmaPage.hasDayAccepted('22').hasMonthAccepted('05').hasYearAccepted('2020');

        editSrmaPage.withDayAccepted('17').withMonthAccepted('06').withYearAccepted('2021').save();
        ...
        viewSrmaPage.addDateReportSentToTrust();
        editSrmaPage.hasDayReportSentToTrust('05').hasMonthReportSentToTrust('12').hasYearReportSentToTrust('2021');
        ...
        editSrmaPage.withNotesExceedingLimit().save().hasValidationError(SrmaNotesError);
    ...
    it('Should show correct empty label order dependant on dates of visit', () => {
        ...
        editSrmaPage.withStartDayOfVisit('05').withStartMonthOfVisit('07').withStartYearOfVisit('2023').save();
    ...
    describe('Closing an SRMA', () => {
        it('Should be able to resolve an SRMA', () => {
            ...
            validationComponent.hasValidationErrorsInOrder(['Confirm SRMA action is complete', SrmaNotesError]);
        ...
        it('Should cancel an SRMA', () => {
            ...
            editSrmaPage.save().hasValidationError('Confirm SRMA action was cancelled');
        ...
        it('Should decline an SRMA', () => {
            ...
            editSrmaPage.save().hasValidationError('Confirm SRMA action was declined by trust');
        ...
        it('Deleting an SRMA', () => {
            ...
            actionSummaryTable.assertRowDoesNotExist('SRMA', 'open');
        });
    });

    function setValidStartDateOfVisit() {
        editSrmaPage.withStartDayOfVisit('22').withStartMonthOfVisit('07').withStartYearOfVisit('2021');
    }
