...
describe('Testing the NTI under consideration', () => {
    ...
    describe('When adding or editing a new NTI under consideration', () => {
        it('Should create an NTI with the values specified and be able to edit the values', () => {
            ...
            editNtiUnderConsiderationPage.withNotesExceedingLimit().save().hasValidationError(NotesError);
    ...
    describe('When adding a blank NTI under consideration', () => {
        it('Should set the fields to empty', () => {
            ...
            viewNtiUnderConsiderationPage.hasDateOpened(toDisplayDate(now)).hasReason('Empty').hasNotes('Empty');
        });
    });
    ...
    describe('When closing an NTI under consideration', () => {
        it('Should be able to close the NTI under consideration', () => {
            ...
            closeNtiUnderConsiderationPage.withStatus('NoFurtherAction').withNotes('These are my final notes').close();

            Logger.log('Review the closed NTI under consideration');
            actionSummaryTable.getClosedAction('NTI Under Consideration').then((row) => {
                row.hasName('NTI Under Consideration');
    ...
    describe('When deleting an NTI under consideration', () => {
        it('Should be able to delete the NTI under consideration', () => {
            ...
            actionSummaryTable.assertRowDoesNotExist('NTI Under Consideration', 'open');
        });
    });
