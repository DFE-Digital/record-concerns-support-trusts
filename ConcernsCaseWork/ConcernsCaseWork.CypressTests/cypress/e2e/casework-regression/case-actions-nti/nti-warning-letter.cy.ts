...
describe('Testing the NTI warning letter action', () => {
    ...
    it('Should be able to add and edit an NTI warning letter', () => {
        ...
        editNtiWarningLetterPage.clearConditions().withCondition('Scheme of delegation').saveConditions();
    ...
    it('Should be able to close an NTI warning letter', () => {
        ...
        closeNtiWarningLetterPage.hasNotes('This is my notes');
        ...
        closeNtiWarningLetterPage.withReason('ConditionsMet').withNotes('This is my final notes');

        closeNtiWarningLetterPage.close();

        Logger.log('Validate the Closed NTI warning letter on the view page');
        actionSummaryTable.getClosedAction('NTI Warning Letter').then((row) => {
            row.hasName('NTI Warning Letter');
    ...
    it('Should be able to delete an NTI warning letter', () => {
        ...
        actionSummaryTable.assertRowDoesNotExist('NTI Warning Letter', 'open');
    });
