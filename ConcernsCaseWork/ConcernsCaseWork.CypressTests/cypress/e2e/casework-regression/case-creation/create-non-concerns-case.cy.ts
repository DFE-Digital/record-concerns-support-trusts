...
describe('Creating a non concerns case', () => {
    ...
    it('Should validate adding a case', () => {
        ...
        caseManagementPage.hasTrust(trustName).hasManagedBy('SFSO', territory).hasCaseOwner(name);
        ...
        viewSrmaPage.hasStatus('Trust considering').hasDateTrustContacted('05 June 2022').hasNotes('This is my notes');
