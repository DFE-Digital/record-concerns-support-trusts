...
describe('Creating a case', () => {
    ...
    describe('Case journey', () => {
        ...
        it('Should create a case with region group', () => {
            ...
            selectCaseDivisionPage.withCaseDivision('RegionsGroup').continue();
            ...
            addRegionPage.withRegion('London').nextStep();
            ...
            editRegionPage.hasRegion('London').withRegion('South West').apply();
    ...
    describe('Case actions', () => {
        ...
        it('Should create a decision', () => {
            ...
            editDecisionPage.hasNoRetrospectiveRequestField().hasNoDateESFAField().hasNoTotalAmountRequestedField();
