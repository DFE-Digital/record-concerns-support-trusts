...
namespace ConcernsCaseWork.Service.Tests.RecordSrma
{
	...
	public class RecordSrmaServiceTests
	{
		...
		{
			// arrange
			var requestDto = RecordSrmaFactory.BuildCreateRecordSrmaDto();
			var expectedRecordSrma = RecordSrmaFactory.BuildRecordSrmaDto(requestDto);
			...
			// act
			var actualRecordSrma = await recordSrmaService.PostRecordSrmaByRecordUrn(requestDto);
