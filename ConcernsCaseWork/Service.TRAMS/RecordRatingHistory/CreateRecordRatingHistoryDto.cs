...
{
	public sealed class CreateRecordRatingHistoryDto
	{
		...
		[JsonConstructor]
		public CreateRecordRatingHistoryDto(DateTimeOffset createdAt, BigInteger recordUrn, BigInteger ratingUrn) => 
