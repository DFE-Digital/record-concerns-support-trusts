...
namespace Service.Redis.Tests.Type
{
	...
	public class TypeCachedServiceTests
	{
		...
		[Test]
		public async Task WhenGetTypeByNameAndDescription_ReturnsTypes_CacheIsNotNull()
		{
			// arrange
			var mockCacheProvider = new Mock<ICacheProvider>();
			var mockTypeService = new Mock<ITypeService>();
			...
			// act
			var actualType = await typeCachedService.GetTypeByNameAndDescription("Compliance", "Compliance: Financial reporting");
