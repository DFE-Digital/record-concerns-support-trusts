...
namespace ConcernsCaseWork.Service.Nti
{
	public class NtiStatusesService : ConcernsAbstractService, INtiStatusesService
	{
		...
		public NtiStatusesService(IHttpClientFactory httpClientFactory, ILogger<NtiStatusesService> logger, ICorrelationContext correlationContext, IUserContextService userContextService) : base(httpClientFactory, logger, correlationContext, userContextService)
		{
			_logger = logger;
		}
