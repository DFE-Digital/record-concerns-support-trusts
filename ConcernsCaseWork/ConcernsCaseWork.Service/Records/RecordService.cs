...
namespace ConcernsCaseWork.Service.Records
{
	public sealed class RecordService : ConcernsAbstractService, IRecordService
	{
		...
		public RecordService(IHttpClientFactory clientFactory, ILogger<RecordService> logger, ICorrelationContext correlationContext, IClientUserInfoService userInfoService, IUserTokenService userTokenService) : base(clientFactory, logger, correlationContext, userInfoService, userTokenService)
		{
			_logger = logger;
		}
