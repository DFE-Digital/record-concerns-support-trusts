/*
This is a clone of the Gov UK character count code
In order to properly count characters we needed to make some modifications
...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
		typeof define === 'function' && define.amd ? define('Concerns.CharacterCount', factory) :
			(global.Concerns = global.Concerns || {}, global.Concerns.CharacterCount = factory());
}(this, (function () {
	'use strict';
	...
	function CharacterCount($module, config) {
		...
		this.$module = $module;
		this.$textarea = $module.querySelector('.govuk-js-concerns-character-count');
	...
	CharacterCount.prototype.count = function (text) {
		if (this.config.maxwords) {
			...
			return text.length + numberOfNewLines;
		}
	};
