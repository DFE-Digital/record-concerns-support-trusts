...
namespace ConcernsCaseWork.Pages.Case.Management.Action.SRMA
{
	...
	public class EditSRMAReasonOfferedPageModel : AbstractPageModel
	{
		...
		public EditSRMAReasonOfferedPageModel(ISRMAService srmaService, ILogger<EditCurrentStatusPageModel> logger)
		{
		...
		{
			var statuses = (SRMAReasonOffered[])Enum.GetValues(typeof(SRMAReasonOffered));
			return statuses.Where(r => r != SRMAReasonOffered.Unknown)
