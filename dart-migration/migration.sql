USE [DaRT_Sandbox]
GO
/****** Object:  Schema [dartmigration]    Script Date: 23/01/2023 15:18:27 ******/
CREATE SCHEMA [dartmigration]
GO
/****** Object:  UserDefinedTableType [dartmigration].[CaseUrnTableType]    Script Date: 23/01/2023 15:18:27 ******/
...
GO
/****** Object:  UserDefinedFunction [dartmigration].[AddLabelAndValueLineIfNotNull]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetCaseHistory]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Create the case history including the academy name and URN if a concern has been raised against an academy in DaRT
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetConcernCaseStatusId]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetConcernRatingId]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetConcernRecordStatusId]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetConcernsCaseClosedDate]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetConcernTypeId]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetDateOrMinimumIfNull]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetMeansOfReferralId]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetTerritory]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dartmigration].[GetTrustUkPrn]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dartmigration].[dart extract]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dartmigration].[vwConcernCaseRaw]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dartmigration].[DartUsers]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dartmigration].[vwConcernsCaseTransformed]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT        
	...
	dartmigration.GetCaseHistory(Case_History, URN, Academy_Name) AS CaseHistory,
...
GO
/****** Object:  View [dartmigration].[vwConcernsRecordRaw]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
WHERE        (Case_Type = 'Concern')
GO
/****** Object:  View [dartmigration].[vwConcernsRecordTransformed]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dartmigration].[CaseIdsToBeImported]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dartmigration].[giasgroup]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dartmigration].[uspExportDartExtractToConcerns_TestData_Step1-Cases]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
 ...
 END
GO
/****** Object:  StoredProcedure [dartmigration].[uspExportDartExtractToConcerns_TestData_Step2-Records]    Script Date: 23/01/2023 15:18:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
